...
public class UserSettings {
    ...
    public UserSettings(int username_min_length, int username_max_length, int password_min_length, int password_max_length, int email_min_length, int email_max_length, int min_age) {
